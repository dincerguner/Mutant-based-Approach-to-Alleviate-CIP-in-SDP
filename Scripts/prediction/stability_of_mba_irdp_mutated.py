...
RESULT_CSV_PATH = "../../Performance Results/Stability of MBA/IRDP/performance_irdp_mutated.csv"
RANDOM_STATE = 42
...
ratio_mapping = {
    "ant_1.3_org_java_1.3_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "ant_1.4_org_java_1.3_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "ant_1.5_org_java_1.3_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "ant_1.6_org_java_1.4.1_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "jEdit_3.2.1_org_java_1.3_ext_2.2_j16_45.csv": [0.4, 0.5],
    "jEdit_4.0_org_java_1.4.0_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "jEdit_4.1_org_java_1.4.0_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "jEdit_4.2_org_java_1.5_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "lucene_2.0_org_java_1.4.2_ext_2.2_j16_45.csv": [0.5],
    "pBeans_1.0_org_java_1.4.0_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "poi_2.0RC1_org_java_1.4.0_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "synapse_1.0_org_java_1.5_ext_2.2_j16_45.csv": [
        0.3
    ],  # [0.3, 0.4, 0.5], (because we can reach almost 0.3 with all possible mutations)
    "synapse_1.1_org_java_1.5_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
    "xalan_2.6_org_java_1.3_ext_2.2_j16_45.csv": [0.5],
    "xerces_1.2.0_org_java_1.3_ext_2.2_j16_45.csv": [0.3, 0.4, 0.5],
}
